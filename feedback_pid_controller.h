...
typedef struct
{
    ...
    //float lastInput;
    // 
    // Previous error to the PID Controller
    // 
    float pre_error;
    // 
    // Previous error to the previous error of PID Controller
    // 
    float pre_two_error;
    // 
    ...
    // float alteredKd;
    // // 
    // // FdK-反馈强度和 PreK-预测强度以及 PreKv-非线性补偿
    // // 
    // // 
    float FdK;
    float PreK;
...
//      Nothing.
// 
extern void PIDInit(PIDControl *pid, float FdK, float PreK, float PreKv, 
...
//      Nothing.
// 
extern void PIDTuningsSet(PIDControl *pid, float FdK, float PreK, float PreKv);         	                                         
...
//      Nothing.
// 
extern void PIDTuningFdkSet(PIDControl *pid, float kp);
...
//      Nothing.
// 
extern void PIDTuningPreKSet(PIDControl *pid, float ki);
...
//      Nothing.
// 
extern void PIDTuningPreKvSet(PIDControl *pid, float kd);
...
// 
extern __inline float 
PIDFdKGet(PIDControl *pid) { return pid->FdK; }						  
...
// 
extern __inline float 
PIDPreKGet(PIDControl *pid) { return pid->PreK; }						  
...
// 
extern __inline float 
PIDErrorGet(PIDControl *pid) { return (pid->setpoint) - (pid->input); }		

extern __inline float 
PIDPreErrorGet(PIDControl *pid) { return pid->pre_error; }			

extern __inline float 
PIDPreTwoErrorGet(PIDControl *pid) { return pid->pre_two_error; }		
...
// 
extern __inline float 
PIDPreKvGet(PIDControl *pid) { return pid->PreKv; }	
